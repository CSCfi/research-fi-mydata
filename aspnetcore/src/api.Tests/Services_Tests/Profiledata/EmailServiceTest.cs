...
namespace api.Tests.Profiledata
{
    ...
    public class EmailServiceTests
    {
        ...
        private EmailService CreateService(TtvContext context)
        {
            return new EmailService(
                ttvContext: context,
                languageService: new LanguageService(),
                logger: new NullLogger<EmailService>());
        }
        ...
        [Fact]
        public async Task GetProfileEditorEmails_ReturnsEmails_ForElasticsearch_WhenMatchingUserProfileExists()
        {
            using var context = CreateInMemoryContext(nameof(GetProfileEditorEmails_ReturnsEmails_ForElasticsearch_WhenMatchingUserProfileExists));
            var testData = EmailServiceTestData.Create();
            await testData.SeedAsync(context);
