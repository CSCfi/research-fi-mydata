...
namespace api.Tests
{
    public class ProfileDataServiceTestData
    {
        ...
        public static ProfileDataServiceTestData Create()
        {
            ...
            ffvPublication3.DimPublicationId = data.DimPublications[2].Id;
            ffvPublication3.DimPublication = data.DimPublications[2];
            ...
            // FactFieldValue - profile only Publication 3
            ...
            ffvProfileOnlyPublication3.DimProfileOnlyPublicationId = data.DimProfileOnlyPublications[2].Id;
            ffvProfileOnlyPublication3.DimProfileOnlyPublication = data.DimProfileOnlyPublications[2];
