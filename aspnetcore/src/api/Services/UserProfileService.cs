                    ...
                    case Constants.FieldIdentifiers.ACTIVITY_RESEARCH_ACTIVITY:
                        ...
                        if (p.FactFieldValues_DimProfileOnlyResearchActivityId != -1)
                        {
                            ...
                            ProfileEditorActivityAndReward activityAndRewardProfileOnly = new()
                            {
                                ...
                                ActivityTypeCode = p.DimProfileOnlyResearchActivity_Role_CodeValue,
                                ActivityTypeNameFi = nameTraslationProfileOnlyResearchActivityRoleName.NameFi,
                                ActivityTypeNameEn = nameTraslationProfileOnlyResearchActivityRoleName.NameEn,
                                ActivityTypeNameSv = nameTraslationProfileOnlyResearchActivityRoleName.NameSv,
