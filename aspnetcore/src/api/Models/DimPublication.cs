...
namespace api.Models
{
    public partial class DimPublication
    {
        ...
        public virtual DimReferencedata ArticleTypeCodeNavigation { get; set; }
        public virtual DimPublication DimPublicationNavigation { get; set; }
        public virtual DimReferencedata ParentPublicationTypeCodeNavigation { get; set; }
        public virtual DimReferencedata PublicationTypeCode2Navigation { get; set; }
        public virtual DimReferencedata TargetAudienceCodeNavigation { get; set; }
