    ...
    public class UserProfileController : TtvControllerBase
    {
        ...
        public async Task<IActionResult> Create()
        {
            ...
            if (dimPid.DimKnownPerson.DimUserProfiles.FirstOrDefault() == null)
            {
                ...
                foreach (int fieldIdentifier in new List<int> { Constants.FieldIdentifiers.PERSON_FIRST_NAMES, Constants.FieldIdentifiers.PERSON_LAST_NAME, Constants.FieldIdentifiers.PERSON_OTHER_NAMES, Constants.FieldIdentifiers.PERSON_RESEARCHER_DESCRIPTION, Constants.FieldIdentifiers.PERSON_WEB_LINK, Constants.FieldIdentifiers.PERSON_EMAIL_ADDRESS, Constants.FieldIdentifiers.PERSON_KEYWORD })
                {
