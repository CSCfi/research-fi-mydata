# Generated by Django 3.0.1 on 2020-07-03 09:54
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('areas_of_interest', models.ManyToManyField(to='research.AreaOfInterest')),
                ('datasource_org1', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='+', to='research.Datasource')),
                ('datasource_org2', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='+', to='research.Datasource')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('projectName', models.CharField(blank=True, max_length=512, null=True)),
                ('projectShortName', models.CharField(blank=True, max_length=512, null=True)),
                ('projectAbbreviation', models.CharField(blank=True, max_length=512, null=True)),
                ('projectType', models.CharField(blank=True, max_length=512, null=True)),
                ...
                ('includeInProfile', models.BooleanField(default=False)),
                ('datasource', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='research.Datasource')),
                ('researchprofile', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='other_projects', to='research.ResearchProfile')),
            ],
        ),
        migrations.CreateModel(
            name='Merit',
