# Generated by Django 3.0.1 on 2019-12-20 12:38
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('reviewerRole', models.CharField(blank=True, max_length=512)),
                ('reviewUrl', models.CharField(blank=True, max_length=512)),
                ('reviewType', models.CharField(blank=True, max_length=512)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('datasource', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='research.Datasource')),
                ('researchprofile', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='invited_positions', to='research.ResearchProfile')),
            ],
        ),
        migrations.CreateModel(
            name='Funding',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('datasource', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='research.Datasource')),
                ('researchprofile', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='employments', to='research.ResearchProfile')),
            ],
            options={
                'ordering': ['-endYear'],
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('endYear', models.PositiveSmallIntegerField(null=True)),
                ('datasource', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='research.Datasource')),
                ('researchprofile', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='educations', to='research.ResearchProfile')),
            ],
            options={
                'ordering': ['-endYear'],
            },
