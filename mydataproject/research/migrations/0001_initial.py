# Generated by Django 3.0.1 on 2020-03-23 09:41
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('includeInProfile', models.BooleanField(default=False)),
                ('datasource', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='research.Datasource')),
                ('researchprofile', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='projects', to='research.ResearchProfile')),
            ],
        ),
        migrations.CreateModel(
            name='PersonPhone',
